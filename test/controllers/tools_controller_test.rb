...
class ToolsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tool" do
    assert_difference('Tool.count') do
      post tools_url, params: { tool: { description: @tool.description, img: @tool.img, myskill_id: @tool.myskill_id, name: @tool.name, user_id: @tool.user_id } }
    end
  ...
  test "should update tool" do
    patch tool_url(@tool), params: { tool: { description: @tool.description, img: @tool.img, myskill_id: @tool.myskill_id, name: @tool.name, user_id: @tool.user_id } }
