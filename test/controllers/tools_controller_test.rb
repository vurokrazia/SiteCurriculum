...
class ToolsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tool" do
    assert_difference('Tool.count') do
      post tools_url, params: { tool: { description: @tool.description, skill_id: @tool.skill_id, t_image: @tool.t_image, title: @tool.title, user_id: @tool.user_id } }
    end
  ...
  test "should update tool" do
    patch tool_url(@tool), params: { tool: { description: @tool.description, skill_id: @tool.skill_id, t_image: @tool.t_image, title: @tool.title, user_id: @tool.user_id } }
