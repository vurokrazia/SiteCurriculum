...
class ExperiencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create experience" do
    assert_difference('Experience.count') do
      post experiences_url, params: { experience: { title: @experience.title, user_id: @experience.user_id } }
    end
  ...
  test "should update experience" do
    patch experience_url(@experience), params: { experience: { title: @experience.title, user_id: @experience.user_id } }
